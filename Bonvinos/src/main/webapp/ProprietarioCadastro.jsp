		...
		<div id="main" class="container">
			...
			<form action="controller.do" method="post">
				...
				<div id="actions" class="row">
					<div class="md-col-12">
						<button type="submit" class="btn btn-primary" name="command" value="ManterProprietario">Cadastrar</button>
						<a class="dropdown-item" href="loginProprietario.jsp">Já possuo cadastro</a>
					</div>
				</div>
			</form>
		</div>
