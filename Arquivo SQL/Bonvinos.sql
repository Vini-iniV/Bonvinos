...
DROP SCHEMA IF EXISTS Bonvinos;
CREATE SCHEMA IF NOT EXISTS `Bonvinos` DEFAULT CHARACTER SET utf8 ;
USE `Bonvinos` ;

-- -----------------------------------------------------
-- Tabela Cliente
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Bonvinos`.`Cliente` (
...
-- Tabela Proprietario
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Bonvinos`.`Proprietario` (
...
-- Tabela Restaurante
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Bonvinos`.`Restaurante` (
  ...
  CONSTRAINT `fk_Restaurante_Proprietario1`
    ...
    REFERENCES `Bonvinos`.`Proprietario` (`CNPJ`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- Tabela Mesa
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Bonvinos`.`Mesa` (
  ...
  CONSTRAINT `fk_Mesa_Restaurante`
    ...
    REFERENCES `Bonvinos`.`Restaurante` (`codRestaurante`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- Tabela Reserva
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Bonvinos`.`Reserva` (
  ...
  CONSTRAINT `fk_Reserva_Mesa1`
    ...
    REFERENCES `Bonvinos`.`Mesa` (`codMesa` , `Restaurante_codRestaurante`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Reserva_Cliente1`
    FOREIGN KEY (`Cliente_CPF`)
    REFERENCES `Bonvinos`.`Cliente` (`CPF`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
    ENGINE = InnoDB;